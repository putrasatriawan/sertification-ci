        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    <div>Edit Hak Akses <div class="page-title-subheading"> </div>
                    </div>
                </div>
            </div>
        </div>
                          ...
                          <h3 class="box-title"><i class="fa fa-tag"></i> <?php echo ucwords(str_replace("_", " ", $role_name)); ?></h3>
                                        ...
                                        <div class="box-body">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select id="role_id"
                                                        ...
                                                        <?php foreach ($roles as $role) { ?> <option
                                                                        value="<?php echo $role->id; ?>"
                                                                        <?php echo $role->id == $id ? "selected" : "" ?>>
                                            ...
                                            <table id="tabweb"
                                                ...
                                                <thead>
                                                    <th style="width:70px"> <label
                                                               class="mar-0 control control--checkbox"><input type="checkbox"
                                                                   id="checkAll">
                                                  ...
                                                  if (!empty($data_menu['name'])) {
                                                    ?> <tr>
                                                                    ...
                                                                    <td> <span class="valign-mid"><?php echo $data_menu['name']; ?></span>
                                                                        <div
                                                                             class="btn-group dropdown pull-right padright-15 borright-soft-grey">
                                                                            <button class="btn white dropdown-toggle btn-sm hide-caret"
                                                                                    data-toggle="dropdown">Pilih Fungsi</button>
                                                                            <div
                                                                                 class="dropdown-menu dropdown-menu-form dropdown-menu-scale pull-right function-parent"> <?php
                                                                                 foreach ($data_menu['functions'] as $function) {
                                                                                   if (!empty($function["id"] && $function['name'])) {
                                                                                     ...
                                                                                     ?> <label class="col-12 control control--checkbox">
                                                                                                    <span
                                                                                                          class="pull-left fsize-14 padleft-10"><?php echo $function['name'] ?>
                                                                                                    </span>
                                                                                                    <input type="checkbox"
                                                                                                           class="cb-element-child function-<?php echo $function['id'] ?>"
